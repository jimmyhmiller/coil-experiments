...
*/
#define PATH_LOADSEARCH "/usr/local/share/emacs/30.2.50/lisp"

/* Like PATH_LOADSEARCH, but contains the relative path from the
   installation directory.
*/
#define PATH_REL_LOADSEARCH "30.2.50/lisp"
...
*/
#define PATH_SITELOADSEARCH "/usr/local/share/emacs/30.2.50/site-lisp:/usr/local/share/emacs/site-lisp"
...
*/
#define PATH_DUMPLOADSEARCH "/Users/jimmyhmiller/Documents/Code/projects/coil-experiments/.worktrees/emacs-c-reader/src/apps/emacs/vendor/emacs/lisp"
...
#define PATH_EXEC "/usr/local/libexec/emacs/30.2.50/aarch64-apple-darwin25.5.0"

/* Where Emacs should look for its architecture-independent data
   files, like the NEWS file.  The lisp variable data-directory
   is set to this value.  */
#define PATH_DATA "/usr/local/share/emacs/30.2.50/etc"
...
#define PATH_DOC "/usr/local/share/emacs/30.2.50/etc"
