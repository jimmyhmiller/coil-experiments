...
#define EMACS_CONFIGURATION "aarch64-apple-darwin25.5.0"

/* Summary of some of the main features enabled by configure. */
#define EMACS_CONFIG_FEATURES "ACL FREETYPE GNUTLS HARFBUZZ LCMS2 LIBXML2 MODULES NOTIFY KQUEUE PDUMPER SQLITE3 THREADS TREE_SITTER ZLIB"

/* Define to the options passed to configure. */
#define EMACS_CONFIG_OPTIONS "--with-x=no --with-ns=no --without-x-toolkit --with-gnutls=ifavailable --without-native-compilation --with-jim 'CFLAGS=-std=gnu11 -g3 -O2' 'CPPFLAGS=-I/opt/homebrew/opt/llvm/include -I/opt/homebrew/opt/openssl@3/include' 'LDFLAGS=-L/opt/homebrew/opt/llvm/lib -L/opt/homebrew/opt/openssl@3/lib'"
...
/* Define if Emacs is built with the Jim editor backend. */
#define HAVE_JIM 1
...
#define PACKAGE_STRING "GNU Emacs 30.2.50"
...
#define PACKAGE_VERSION "30.2.50"
