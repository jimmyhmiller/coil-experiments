...
for production in \
  word string spread regexp primary property object-shorthand object call member computed-member postfix expression declaration \
...
printf '%s\n' 'all 51 direct-parser productions are generated'
