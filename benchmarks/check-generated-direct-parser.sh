...
for production in \
  word string spread primary property object-shorthand object call member computed-member postfix expression declaration \
...
printf '%s\n' 'all 50 direct-parser productions are generated'
